...
**Artifact**: [Corner Takers 2026/27](corner_takers_2026_27.csv) · [Team Net Swings 2025/26](team_set_piece_swing_2025_26.csv) · [Player Leaders 2025/26](player_set_piece_leaders_2025_26.csv)
...
- **Repository data**: `docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.csv` — player roles and Draft eligibility.
...
```text
Full redo docs/archive/fpl-set-piece-analysis/fpl-set-piece-analysis.md
...
4. Refresh companion CSVs in docs/archive/fpl-set-piece-analysis/.
...
**Recommended action**:
- Retain companion CSVs in `docs/archive/fpl-set-piece-analysis/`.
- Cross-reference taker hierarchies against `docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.csv` during pre-GW1 squad selection.

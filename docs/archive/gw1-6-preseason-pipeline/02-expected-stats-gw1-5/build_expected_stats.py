...
CAREER_INDIVIDUAL_RATES: dict[int, dict] = {
    ...
    114: {"xg": 0.06, "xa": 0.06, "saves": 0.00, "defcon": 4.25, "defcon_cbit": True,
          "note": "Position baseline (DEF); dest GC BHA; no Prior-Season Seed"},
    195: {"xg": 0.41, "xa": 0.13, "saves": 0.00, "defcon": 1.50, "defcon_cbit": True,
          "note": "Position baseline (FWD); dest GC COV; no Prior-Season Seed"},
    207: {"xg": 0.06, "xa": 0.06, "saves": 0.00, "defcon": 4.25, "defcon_cbit": True,
          "note": "Position baseline (DEF); dest GC CRY; no Prior-Season Seed"},
    396: {"xg": 0.06, "xa": 0.06, "saves": 0.00, "defcon": 4.25, "defcon_cbit": True,
          "note": "Position baseline (DEF); dest GC MCI; no Prior-Season Seed"},
    565: {"xg": 0.15, "xa": 0.15, "saves": 0.00, "defcon": 3.10, "defcon_cbit": True,
          "note": "Position baseline (MID); dest GC BRE; no Prior-Season Seed"},
    566: {"xg": 0.06, "xa": 0.06, "saves": 0.00, "defcon": 4.25, "defcon_cbit": True,
          "note": "Position baseline (DEF); dest GC BOU; no Prior-Season Seed"},
    567: {"xg": 0.000, "xa": 0.000, "saves": 2.25, "defcon": 0.00, "defcon_cbit": True,
          "note": "2025/26 Liga Portugal Braga GKP; 2960m; FootyMetrics/FootyStats 74 saves (2.25/90)"},
    569: {"xg": 0.41, "xa": 0.13, "saves": 0.00, "defcon": 1.50, "defcon_cbit": True,
          "note": "Position baseline (FWD); dest GC FUL; no Prior-Season Seed"},
    570: {"xg": 0.15, "xa": 0.15, "saves": 0.00, "defcon": 3.10, "defcon_cbit": True,
          "note": "Position baseline (MID); dest GC FUL; no Prior-Season Seed"},
    572: {"xg": 0.000, "xa": 0.000, "saves": 1.72, "defcon": 0.00, "defcon_cbit": True,
          "note": "2025/26 Super League Olympiacos GKP; 2880m; FootyMetrics 55 saves (1.72/90)"},
    574: {"xg": 0.15, "xa": 0.15, "saves": 0.00, "defcon": 3.10, "defcon_cbit": True,
          "note": "Position baseline (MID); dest GC HUL; no Prior-Season Seed"},
    575: {"xg": 0.15, "xa": 0.15, "saves": 0.00, "defcon": 3.10, "defcon_cbit": True,
          "note": "Position baseline (MID); dest GC COV; no Prior-Season Seed"},
    576: {"xg": 0.15, "xa": 0.15, "saves": 0.00, "defcon": 3.10, "defcon_cbit": True,
          "note": "Position baseline (MID); dest GC HUL; no Prior-Season Seed"},
    581: {"xg": 0.06, "xa": 0.06, "saves": 0.00, "defcon": 4.25, "defcon_cbit": True,
          "note": "Position baseline (DEF); dest GC NFO; no Prior-Season Seed"},
    586: {"xg": 0.06, "xa": 0.06, "saves": 0.00, "defcon": 4.25, "defcon_cbit": True,
          "note": "Position baseline (DEF); dest GC HUL; no Prior-Season Seed"},
}
...
def build_expected_stats(
    role_csv_path: str = "docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.csv",
    archive_processed: str = "data/archive/2025-26/processed",
    players_parquet: str = "data/processed/players.parquet",
    output_csv_path: str = "docs/archive/gw1-6-preseason-pipeline/02-expected-stats-gw1-5/expected-stats-gw1-5.csv",
) -> pd.DataFrame:

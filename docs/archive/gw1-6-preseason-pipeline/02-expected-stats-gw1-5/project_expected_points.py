...
def project_gw1_5_points(
    stats_csv_path: str = "docs/archive/gw1-6-preseason-pipeline/02-expected-stats-gw1-5/expected-stats-gw1-5.csv",
    ...
    output_csv_path: str = "docs/archive/gw1-6-preseason-pipeline/02-expected-stats-gw1-5/gw1-5_projections.csv",

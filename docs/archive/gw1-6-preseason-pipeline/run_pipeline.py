...
docs/archive/ownership-value-explorer/
"""
...
def main():
    ...
    stage1_spec = importlib.util.spec_from_file_location(
        "refresh_role",
        root_dir / "docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/refresh_expected_role.py"
    )
    ...
    stats_spec = importlib.util.spec_from_file_location(
        "build_stats",
        root_dir / "docs/archive/gw1-6-preseason-pipeline/02-expected-stats-gw1-5/build_expected_stats.py"
    )
    ...
    points_spec = importlib.util.spec_from_file_location(
        "project_points",
        root_dir / "docs/archive/gw1-6-preseason-pipeline/02-expected-stats-gw1-5/project_expected_points.py"
    )
    ...
    wc4_spec = importlib.util.spec_from_file_location(
        "run_wc4",
        root_dir / "docs/archive/gw1-6-preseason-pipeline/03-gw1-6-chip-wc4-squads/run_wc4_simulation.py"
    )
    ...
    projections_path = root_dir / "docs/archive/gw1-6-preseason-pipeline/03-gw1-6-chip-wc4-squads/gw1-6_projections.csv"

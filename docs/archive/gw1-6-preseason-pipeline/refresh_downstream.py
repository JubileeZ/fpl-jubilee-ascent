...
def main() -> None:
    ...
    _load(
        "docs/archive/gw1-6-preseason-pipeline/03-gw1-6-chip-wc4-squads/run_wc4_simulation.py",
        "run_full_wc4_study",
    )()
    ...
    _load(
        "docs/archive/ownership-value-explorer/plot_ownership_value_explorer.py",
        "main",
    )()

    print("\n=== DOWNSTREAM REFRESH COMPLETE ===")
    _load("docs/archive/sync_live_research_figures.py", "sync_all")()

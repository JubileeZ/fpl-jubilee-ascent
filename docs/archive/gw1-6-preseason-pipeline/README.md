...
**Status**: Archived (2026/27 preseason). Active Master Pipeline  
...
| Situation | Command |
| --- | --- |
| Roles changed (FFS/Meerkat XI, new starter inject) | `uv run python docs/archive/gw1-6-preseason-pipeline/run_pipeline.py` (HTTP). Then add a career package if Stage 2 fail-closes. |
| Rates / career packages changed; roles unchanged | `uv run python docs/archive/gw1-6-preseason-pipeline/refresh_downstream.py` |
...
A. Roles changed (HTTP scrape):
   uv run python docs/archive/gw1-6-preseason-pipeline/run_pipeline.py
...
- Role scrape: `uv run python docs/archive/gw1-6-preseason-pipeline/run_pipeline.py`.
- Rates / new player: `uv run python docs/archive/gw1-6-preseason-pipeline/refresh_downstream.py`.

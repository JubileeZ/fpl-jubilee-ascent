...
def refresh_expected_roles(
    input_csv: str = "docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.csv",
    ...
    md_path = Path("docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.md")
    if md_path.exists():

...
**Artifacts**:
- [Expected Role CSV](expected-role-gw1-5.csv)
...
1. Command: uv run python docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/refresh_expected_role.py
   ...
   - Export CSV to docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.csv.
...
- Stage 1 script: `docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/refresh_expected_role.py`.
- Output CSV: `docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.csv`.

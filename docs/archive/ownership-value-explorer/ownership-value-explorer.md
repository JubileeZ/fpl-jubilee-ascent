...
**Status**: Archived (2026/27 preseason). Active Research Model & Visualization Suite  
...
**Artifacts**:
- [Season projections CSV](season_projections.csv)
- [Metrics CSV](ownership_value_metrics.csv)
- [Interactive HTML](ownership_value_explorer.html)
...
```bash
xdg-open docs/archive/ownership-value-explorer/ownership_value_explorer.html   # Linux
open docs/archive/ownership-value-explorer/ownership_value_explorer.html       # macOS
```
...
**From file manager**: double-click `ownership_value_explorer.html` in `docs/archive/ownership-value-explorer/`.
...
### 1. Pre-WC Sprint Differentials (GW1–3 BB1 Target, 201.65 xP)
...
### 2. Post-WC4 Core Squad Structure (GW4–6 Foundation, 182.11 xP)
...
- Rates: `docs/archive/gw1-6-preseason-pipeline/02-expected-stats-gw1-5/expected-stats-gw1-5.csv`
- Fixtures / clubs / players: `data/processed/`
- Availability priors: `docs/archive/gw1-6-preseason-pipeline/availability_priors.py`
- Simulation overlays: `docs/archive/gw1-6-preseason-pipeline/03-gw1-6-chip-wc4-squads/gw1-6_wc4_simulation.csv`

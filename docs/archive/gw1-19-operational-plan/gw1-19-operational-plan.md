...
**Status**: Archived (2026/27 preseason). Active user playbook. Consumes Canonical + First-Half calendars. Does not replace either.
...
**Artifacts**:
- [Summary](operational_summary.csv)
- [Weeks](operational_weeks.csv)
- [Select 11](operational_select_11.csv)
- [Squads](operational_squads.csv)
- [FT hurdles](operational_ft_hurdles.csv)
...
```text
Refresh docs/archive/gw1-19-operational-plan/gw1-19-operational-plan.md

1. Re-read CONTEXT.md Operational First-Half Plan, Canonical Preseason Chip Path, First-Half Chip Path.
2. uv run python docs/archive/gw1-19-operational-plan/export_operational_plan.py
3. Do not run first_half greedy FTs. Do not replace Canonical Stage 3 or first_half_transfers.csv.
4. Identity: docs/archive/gw1-19-operational-plan/operational_summary.csv frozen_19gw_xi_xp

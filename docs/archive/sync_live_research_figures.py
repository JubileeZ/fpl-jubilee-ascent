...
SELECT11 = ROOT / "docs/archive/gw1-6-preseason-pipeline/03-gw1-6-chip-wc4-squads/gw1-6_select_11.csv"
STAGE3_MD = ROOT / "docs/archive/gw1-6-preseason-pipeline/03-gw1-6-chip-wc4-squads/gw1-6-chip-wc4-squads.md"
PIPELINE_MD = ROOT / "docs/archive/gw1-6-preseason-pipeline/README.md"
INDEX_MD = ROOT / "docs/research/INDEX.md"
FH_SUMMARY = ROOT / "docs/archive/gw1-19-first-half-chip-path/first_half_summary.csv"
FH_SELECT = ROOT / "docs/archive/gw1-19-first-half-chip-path/first_half_select_11.csv"
FH_SQUADS = ROOT / "docs/archive/gw1-19-first-half-chip-path/first_half_squads.csv"
FH_MD = ROOT / "docs/archive/gw1-19-first-half-chip-path/gw1-19-first-half-chip-path.md"
FH_README = ROOT / "docs/archive/gw1-19-first-half-chip-path/README.md"
OWN_MD = ROOT / "docs/archive/ownership-value-explorer/ownership-value-explorer.md"
DCS_GKP = ROOT / "docs/archive/defensive-fixture-rotation/gkp_strategy_comparison.csv"
DCS_PART = ROOT / "docs/archive/defensive-fixture-rotation/def_club_partitions_matrix.csv"
DCS_BACK = ROOT / "docs/archive/defensive-fixture-rotation/backline_gw1_19_lineups.csv"
DCS_MD = ROOT / "docs/archive/defensive-fixture-rotation/defensive-fixture-rotation.md"
...
```"""
    ...
    text = text.replace(
        ...
        "Then `uv run python docs/archive/sync_live_research_figures.py` (CSV cells → note caches).",
    )
...
def sync_current_state() -> None:
    """Season-ops snapshot; do not rewrite from archived preseason CSVs."""
    pass
...
"""
    ...
    findings += "- **DCS**: live topic `docs/archive/defensive-fixture-rotation/` (same Seed). This calendar does not write a sibling `dcs/` folder.\n"
    text = re.sub(
        r"### Evidence\n.*?\n### Select 11",
        findings.rstrip() + "\n\n### Select 11",
        text,
    ...
    text = re.sub(
        ...
        "- **DCS**: live topic `docs/archive/defensive-fixture-rotation/` (same Seed). This calendar does not write a sibling `dcs/` folder.\n",
        text,
        count=1,
    )
...
def sync_canonical_rescore_csv() -> None:
    path = ROOT / "docs/archive/gw1-19-first-half-chip-path/canonical_s1_dual_vector_rescore.csv"

...
**Data stamp**: Fantasy Football Scout article modified 2026-07-24 (unchanged on 2026-08-13 recheck); accessed 2026-08-13; Playwright recheck 2026-08-21: article:modified_time unchanged.
**Season**: 2026/27  
**Status**: Archived (2026/27 preseason). Source synthesis · Playwright full-page extracted · Cross-checked against expected-role & summer-transfers  
...
```text
Full redo docs/archive/fpl-preseason-guide/fpl-4-0m-defenders.md
...
7. If new primary articles appear under 'BEST FPL PLAYERS FOR 2026/27' on the pre-season guide index, generate dedicated research notes for them following this exact process and update docs/archive/fpl-preseason-guide.md.

...
**Season**: 2026/27  
**Status**: Archived (2026/27 preseason). Source synthesis · Playwright extracted & cross-checked  
...
```text
Full redo docs/archive/fpl-preseason-guide/fpl-4-5m-midfielders.md

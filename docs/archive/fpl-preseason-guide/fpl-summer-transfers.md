...
**Data stamp**: Fantasy Football Scout transfer register includes moves announced through 2026-08-19 (modified 2026-08-20T09:09:23Z); Playwright capture 2026-08-21
**Season**: 2026/27  
**Status**: Archived (2026/27 preseason). Source synthesis · not independently validated  
...
```text
Full redo docs/archive/fpl-preseason-guide/fpl-summer-transfers.md
...
**Outputs**:
- Verified transfer register note `docs/archive/fpl-preseason-guide/fpl-summer-transfers.md`

**Data stamp / freshness**:
- Register snapshot contains transfers announced 15 May through 19 August 2026.
...
- Register snapshot contains moves announced from 15 May through 19 August 2026.
- Three `.entry-content` images inspected: featured thumbnail, Munoz related-article thumb, Toolkit banner. No statistical data graphics to transcribe.

### Confirmed-move register

Amounts represent source-reported transfer fees.

- **19 August**: Nico Elvedi, Borussia Monchengladbach → Leeds United (£8.5m); Matteo Ruggeri, Atletico Madrid → Aston Villa (£17m); Sidiki Cherif, Fenerbahce → Coventry City (£20.5m); Zion Suzuki, Parma → Aston Villa (£30m).
- **18 August**: Promise David, Union Saint-Gilloise → Brighton and Hove Albion (loan); Zavier Gozo, Real Salt Lake → Crystal Palace (£11.1m); Amar Dedic, Benfica → Newcastle United (£30m).
- **17 August**: Taiwo Awoniyi, Nottingham Forest → Coventry City (£9m); Julio Enciso, Strasbourg → Ipswich Town (combined £47.3m); Abdoul Ouattara, Strasbourg → Ipswich Town (combined £47.3m).
...
- **12 August**: Lucas Herrington, Colorado Rapids → Hull (£12.6m); Nobel Mendy, Rayo Vallecano → Hull (£21m); Geronimo Rulli, Marseille → Man City (£1.7m); Evann Guessand, Aston Villa → Crystal Palace (loan); Pep Chavarria, Rayo Vallecano → Chelsea (£16.3m).
- **11–9 August**: Gustavo Hamer, Sheffield United → Coventry (£6m); Ousmane Diomande, Sporting → Nottingham Forest (£34m); Brennan Johnson, Crystal Palace → Everton (swap); Dwight McNeil, Everton → Crystal Palace (swap); Shea Charles, Southampton → Fulham (£30m); Ronald Araujo, Barcelona → Liverpool (loan); Elliot Stroud, Mjallby → Hull (£3.5m).
- **8–6 August**: Bruno Guimaraes, Newcastle → Arsenal (£75m); Sasa Lukic, Fulham → Ipswich (£9m); Jens Hjerto-Dahl, Tromso → Hull (£10m); Caleb Yirenkyi, Nordsjaelland → Coventry (£23m); James Trafford, Manchester City → Leeds (£45m); Juanlu Sanchez, Sevilla → Bournemouth (£10.4m).
- **5–1 August**: Christian Norgaard, Arsenal → Everton (£7m); Konstantinos Tzolakis, Olympiacos → Hull (£20m); Florentino Luis, Burnley → Ipswich (£16m); Carl Rushworth, Brighton → Coventry (£22m); Gonzalo Garcia, Real Madrid → Fulham (£34.2m); César Palacios, Real Madrid → Fulham (£8.6m); Jordan Henderson, Brentford → Chelsea (free); Lukas Hornicek, Braga → Newcastle (£25.7m); Valentin Barco, Strasbourg → Chelsea (£33.6m); Mamadou Sangare, Lens → Brentford (£38.5m); Danny Welbeck, Brighton → Chelsea (£5m); Antonio Silva, Benfica → Bournemouth (£25.7m).
...
- **Promoted depth**: Ipswich (Enciso + Abdoul Ouattara combined £47.3m, Lukic, Florentino Luis, Scherpen, Maeda, Diop), Coventry (Awoniyi, Cherif, Yirenkyi, Rushworth, Amenda, Tchaouna, Onyeka, Hamer), Hull (Gelhardt, Gourna-Douath, Herrington, Mendy, Stroud, Hjerto-Dahl, Tzolakis, Morita, Targett, Butland, Zambrano) require lineup review.
- **High-impact moves**: Villa (Suzuki, Ruggeri), Leeds (Elvedi, Trafford), Palace (Gozo, Khalaili, Guessand loan, McNeil swap), Arsenal (Bruno Guimaraes, Tzolis, Hincapie, Meslier), Chelsea (Welbeck, Henderson, Barco, Lacroix, Rogers, Quenda, Palestra, Chavarria), Tottenham (Tonali, M. Fernandes, Struijk, Senesi, Robertson), Newcastle (Dedic), Brighton (Promise David loan), Man Utd (Tielemans, Santos, Darlow), Bournemouth (Juanlu Sanchez, A. Silva, A. Rodriguez), Liverpool (Araujo loan, Munoz), Man City (Rulli), Forest (Diomande; Awoniyi out), Fulham (Shea Charles), Everton (Johnson swap).
- **Vacancy checks**: Bruno Guimaraes / Tonali departures from Newcastle; Anderson departure from Forest; Rogers departure from Villa; Awoniyi departure from Forest.
- **Defensive / GK competition**: Suzuki at Villa, Trafford at Leeds, Elvedi at Leeds, Tzolakis at Hull, Rushworth at Coventry, Juanlu at Bournemouth alter starter hierarchies.

## Findings

### Evidence

- Register current through 19 August (latest: Elvedi to Leeds, Ruggeri + Suzuki to Villa, Cherif to Coventry, Promise David loan to Brighton, Gozo to Palace, Dedic to Newcastle, Awoniyi to Coventry, Enciso + Abdoul Ouattara to Ipswich).
- Ten new moves announced 17–19 August vs 18 Aug note. August total = 43 dated IN entries (1–19 August).
- Source spelling: Hull arrival listed as Lucas **Herrington** (prior note used Harrington).
- Norgaard dated 5 August on live register (prior note bucketed him with 8–6 August).
- Fees range from free transfers to £117m; Enciso and Abdoul Ouattara share a combined £47.3m fee.
- FPL prices, minutes evidence, rankings, and player-stat tables absent from fetched text.
- Cross-check against [Expected Role GW1–5](../gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.md): starter statuses for Trafford (Leeds #1), Tzolakis (Hull #1), Rushworth (Coventry #1), and Norgaard (Everton pivot) still listed; new 17–19 Aug arrivals not yet in that table.

...
**Data stamp**: Fantasy Football Scout article published 2026-08-11 (modified 2026-08-11); accessed 2026-08-13; cross-checked against expected-role-gw1-5.md and fpl-summer-transfers.md  ; Playwright recheck 2026-08-21: article:modified_time unchanged.
**Season**: 2026/27  
...
```text
Full redo docs/archive/fpl-preseason-guide/fpl-7-0m-forwards.md

...
**Data stamp**: Fantasy Football Scout article modified 2026-07-28 (unchanged on 2026-08-13 recheck); accessed 2026-08-13; Playwright recheck 2026-08-21: article:modified_time unchanged.
**Season**: 2026/27  
**Status**: Archived (2026/27 preseason). Active · audited & cross-checked  
...
```text
Full redo docs/archive/fpl-preseason-guide/fpl-budget-goalkeepers.md
...
2. Cross-check prices, roles, stats, and claims against docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.md and docs/archive/fpl-preseason-guide/fpl-summer-transfers.md.
...
- `docs/archive/gw1-6-preseason-pipeline/01-expected-role-gw1-5/expected-role-gw1-5.md` Expected Role model & Draft Availability overlay
- `docs/archive/fpl-preseason-guide/fpl-summer-transfers.md` confirmed transfer register

...
STATS_CSV = ROOT / "docs/archive/gw1-6-preseason-pipeline/02-expected-stats-gw1-5/expected-stats-gw1-5.csv"
OUT_CSV = ROOT / "docs/archive/gw1-19-first-half-chip-path/gw1-19_projections.csv"
SEED_CSV = ROOT / "docs/archive/gw1-19-first-half-chip-path/prior_season_dual_vector_seed.csv"
PRIOR_PATH = ROOT / "docs/archive/gw1-6-preseason-pipeline/availability_priors.py"
END_GW = 19

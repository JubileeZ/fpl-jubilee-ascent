...
**Status:** Accepted. Clause 4 (Points-Heavy RQI) superseded by [ADR 0015](0015-defensive-composite-score.md). Clause 2 Dual-Vector Strength remains research architecture — not production Python; live Champion is `calibrated_matchup_hybrid` ([ADR 0041](0041-champion-calibrated-matchup-hybrid.md)). Clauses 1 and 3 unchanged for production.

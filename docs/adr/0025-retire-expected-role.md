...
**Status:** Accepted. Supersedes ADR 0016 remaining Dual-Source / Role-registry clauses. Supersedes ADR 0021 “Dual-Source adapters unchanged” and ADR 0022 optional Explorer Role label. ADR 0022 Club Fixture xMins as the minutes brain still stand; Trailing Start Window (ADR 0035) is data-only on that brain, not Role.

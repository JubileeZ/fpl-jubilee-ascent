...
FH_DIR = ROOT / "data/research/gw1-19-first-half-chip-path"
OUT_DIR = ROOT / "data/research/gw1-19-operational-plan"
CHIP_PY = ROOT / "docs/research/gw1-19-first-half-chip-path/run_chip_path.py"

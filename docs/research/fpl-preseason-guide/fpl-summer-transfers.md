...
7. If new primary articles appear under 'BEST PLAYERS BY POSITION AND PRICE' on the pre-season guide index, generate dedicated research notes for them following this exact process and update docs/research/fpl-preseason-guide.md.

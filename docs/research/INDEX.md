...
- **Downside attack scale (Draft)**: [Note](fixture-downside-scale/fixture-downside-scale.md) · (hard-fixtures-only scale-down vs Champion; dual FDR/xG slices; full run pending)

...
- **Expected Role research (31 Jul):** Q1–Q6 locked and grill closed. Added `docs/research/expected-role-gw1-5.md` plus `data/research/expected-role-gw1-5.csv`: 339 XI Contention rows across 20 Clubs, 194 Draft-eligible (92 Nailed + 102 Regular), 98 Rotation, 47 Cameo. Every row carries Role Evidence and conditional mins priors. Participation State ingest remains follow-up.

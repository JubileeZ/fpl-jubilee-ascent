...
- **Preseason downstream refresh + new-player path (14 Aug):** Stage 3 / GKP / DEF / ownership rebuilt on ADR-0014 rates. Top FH3 **S9 332.34** / top TC3 **S13 340.14**. GKP PL-proven #1 still Verbruggen+Lammens (GW1–6 RQI 87.89 / 38.77 xP; season 83.87 / 232.35 xP); IPS tagged promoted. New Draft player: add `CAREER_INDIVIDUAL_RATES` in `build_expected_stats.py`, then `refresh_downstream.py`. Role scrape still `run_pipeline.py`. Tests green.

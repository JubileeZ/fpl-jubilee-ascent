...
- **No-Haaland GW1–2 + FH3 + WC4 strategy expansion (9 Aug):** Expanded `run_wc4_simulation.py` and `docs/research/gw1-6-preseason-pipeline/03-gw1-6-chip-wc4-squads/` to solve No-Haaland GW1–2 drafts + GW3 Free Hit (FH3) single-GW MILP + GW4 Wildcard. No-Haaland BB1 reaches 119.13 xP in GW1–2 (+4.83 xP vs Haaland BB1); GW3 FH scores 54.98 xP with Haaland/MCI/BRE/LIV/BHA targeting; GW1–3 total reaches 174.11 xP (+6.15 xP vs baseline S1–S3). 6-GW cumulative totals: S7 (BB1+FH3+Opt1) = 325.96 xP, S8 (BB1+FH3+Opt2) = 321.16 xP, S9 (BB1+FH3+Opt3 Cheap DEF + LIV 2+) = 320.67 xP (£3.0m ITB + 2 banked FTs in GW6), S10 (BB2+FH3+Opt3) = 319.92 xP, S11 (Std+FH3+Opt3) = 304.49 xP. Preseason master runner `run_pipeline.py` verified; 142 tests passing.
- **Preseason pipeline & research suite refresh (9 Aug):** Re-audited and updated `docs/research/gw1-6-preseason-pipeline/` end-to-end. Updated `refresh_expected_role.py` with confirmed 8 Aug summer transfers (Bruno Guimarães to Arsenal £75m Nailed Starter, Danny Welbeck to Chelsea £5m rotation depth). Regenerated Stage 1 (340 XI contention rows), Stage 2 (`expected-stats-gw1-5.csv`, `gw1-5_projections.csv`), and Stage 3 (`gw1-6_projections.csv`, `gw1-6_wc4_simulation.csv` re-solving all 6 scenarios of 3x2 matrix: S1 319.81 xP, S2 315.01 xP, S3 314.52 xP, S4 319.15 xP, S5 314.35 xP, S6 313.86 xP). Refreshed all stage markdown docs, master README, `INDEX.md`, and 4 price-bracket research notes (`fpl-5-0m-midfielders.md`, `fpl-6-0m-midfielders.md`, `fpl-6-5m-7-0m-midfielders.md`, `fpl-4-5m-5-5m-forwards.md`). Preseason master runner `run_pipeline.py` verified; 142 tests passing.

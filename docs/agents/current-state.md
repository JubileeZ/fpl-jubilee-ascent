...
- **5-Defender fixture diversification & long-term rotation study (10 Aug):** Full combinatorial evaluation of 15,504 5-club combinations + multi-tier player lineups across GW1–3, GW4–19, GW1–19, and full season. PL-proven #1 5-club rotation is `AVL-CHE-LIV-MCI-NFO` (Rot FDR 2.4386, 100% zero difficult GWs, 26.3% all-easy GWs, r = -0.0679). Top budget rotation: Maatsen+Ajer+Tete+Jair Cunha+Robertson (£22.5m, 275.45 xP, RQI 72.62, 100% FDR<=3). Top anchor rotation: O'Reilly + Maatsen+Tete+Jair Cunha+Robertson (£24.5m, 313.54 xP, RQI 73.96, +38.09 xP boost). Artifacts under `data/research/def-fixture-rotation/`; research note at `docs/research/def-fixture-rotation/def-fixture-rotation.md`.

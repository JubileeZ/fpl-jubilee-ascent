...
- **GKP fixture rotation & FDR correlation study (3 Aug):** Evaluated all 428 starter GKP pairs (£4.0m–£5.5m) with combined cost ≤ £9.5m across GW1–6, GW1–10, GW1–19, and GW1–38. Generated `data/research/gkp-fixture-rotation/gkp_rotation_matrix.csv` and `docs/research/gkp-fixture-rotation/gkp-fixture-rotation.md`. Top pairs: Petrović (£4.5m) + Sels (£5.0m) at £9.5m (r = -0.7618, rotated FDR 2.40 GW1–10); Sels (£5.0m) + Dubravka (£4.0m) at £9.0m (r = -0.3981, rotated FDR 2.47 full season); Palmer (£4.0m) + Dubravka (£4.0m) at £8.0m (r = -0.6704 GW1–10).

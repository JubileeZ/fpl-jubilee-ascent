...
- **GW1–5 chip sim (2 Aug):** Re-run on grill-lock projections. BB1 **299.78** / BB2 **297.77** / Standard **283.84** (+15.9 / +13.9 vs no early BB). XI-aware MILP, £0.5m ITB, no TC. Captains: Hill GW1, Palmer GW2/4, Haaland GW3/5. Not production solver.

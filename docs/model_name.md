...
| `hold_chase_challenger` | `models/hold_chase_challenger.py` | Model Candidate | Champion plus start-persistence participation, top-end ordering emphasis, relaxed hard-fixture defense (#106) |

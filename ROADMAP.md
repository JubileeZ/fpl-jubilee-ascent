...
Next work: wayfinder map [Challenger beats Champion (goals then CS)](https://github.com/JubileeZ/fpl-jubilee-ascent/issues/110). Frontier: [Path after defence_link Historical Promotion Gate FAIL](https://github.com/JubileeZ/fpl-jubilee-ascent/issues/122). Blended dry-run FAIL (#121); soft PASS (#120). Champion `hold_chase_challenger`, provisional.

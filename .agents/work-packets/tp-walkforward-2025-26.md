...
- **Status:** In Progress
- **Objective:** Implement confirmed First-Half Transfer Plan Walk-Forward protocol (ADR 0020)
...
- **Status:** Implementing
- **Files:** `backtesting/strategy_policy.py`, `backtesting/transfer_plan_walkforward.py`, `commands/transfer_plan_walkforward.py`, `docs/adr/0020-transfer-plan-walk-forward-first-half.md`, `docs/research/tp-walkforward-gw1-19-2025-26/`

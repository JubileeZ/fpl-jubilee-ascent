# Dashboard Transfer Plan Re-solve
...
- **Files:** `projections/exporter.py`; `commands/dashboard.py`; `commands/solve.py`; `commands/export_dashboard.py`; `dashboard/app.js`; `dashboard/explorer.js`; `dashboard/index.html`; `tests/test_transfer_plan.py`; `docs/agents/current-state.md`; `task.md`
